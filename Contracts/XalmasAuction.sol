...
// Link to the NFT contract - transfer ownership for auction
interface IERC721 {
...
// Seller should be caller of start function
    constructor () {
...
// end function
    function end() external {
        ...
        if (highestBidder != address(0)) {
            ...
            nft.transferFrom(address(this), seller , nftId);   // return to self if highest bid is 0
        }
